...
<html>
  <head>
    <meta charset="UTF-8">
    <title>RESPEL | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">RESPEL<b>MAX</b></span>
        </a>
...
<?php endif; ?>
<?php endif; ?>
            <li><a href="./?view=sell"><i class='fa fa-usd'></i> <span>Salida de residuos</span></a></li>
...
<?php if(Core::$user->kind==1):?>
       <li><a href="./?view=sellscredit">Salidas credito</a></li>
   <?php endif; ?>
                <li><a href="./?view=bydeliver">Por Entregar</a></li>
                <li><a href="./?view=bycob">Por Cobrar</a></li>
                <li><a href="./?view=sellscancel">Salidas Canceladas</a></li>
          ...
          <?php endif; ?>
            ...
            <li class="treeview <?php if(isset($_GET["view"]) && ($_GET["view"]=="res"||$_GET["view"]=="byreceive" ||$_GET["view"]=="topay"||$_GET["view"]=="rescancel"||$_GET["view"]=="onere")){ echo "active"; }?>">
              <a href="#"><i class='fa fa-clock-o'></i> <span>Ingresos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="./?view=re">Nueva *</a></li>
                <li><a href="./?view=res">Ingreso</a></li>
          ...
          <li><a href="./?view=rescancel">Compras canceladas</a></li>
            ...
            <?php if(Core::$user->kind==1):?>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=brands&opt=all">Peligrosidad</a></li>
                <li><a href="./?view=clients">Destino Final</a></li>
                <li><a href="./?view=providers">Generadores</a></li>
              </ul>
            </li>
          ...
          <?php endif; ?>
            <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="inventary"||$_GET["view"]=="search" ||$_GET["view"]=="inventaries"||$_GET["view"]=="stocks"||$_GET["view"]=="selectstock"||$_GET["view"]=="inventaryval"||$_GET["view"]=="dev"||$_GET["view"]=="trasps"||$_GET["view"]=="devs"||$_GET["view"]=="re"||$_GET["view"]=="traspase"||$_GET["view"]=="onetraspase"||$_GET["view"]=="onedev")){ echo "active"; }?>">
