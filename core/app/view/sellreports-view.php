...
?>
<h1>Comision (<?php echo $uy->comision; ?>%): $ <?php echo number_format($supertotal*($uy->comision/100),2,'.',','); ?></h1>
...
doc.setFontSize(18);
doc.text("TOTAL : $ <?php echo number_format($supertotal,2,'.',','); ?> <?php if(isset($_GET['user_id']) && $_GET['user_id']!='') {$uy = UserData::getById($_GET["user_id"]); echo ' - Comision ('.$uy->comision.'%): $'.number_format($supertotal*($uy->comision/100),2,'.',',') ;}?>", 40, doc.autoTableEndPosY()+25);
doc.setFontSize(12);
